...
keys = ['RA', 'DEC', 'BRICKID', 'BRICKNAME','MORPHTYPE','DCHISQ','FLUX_G', 'FLUX_R', 'FLUX_Z','FLUX_W1','FLUX_W2','MW_TRANSMISSION_G', 'MW_TRANSMISSION_R', 'MW_TRANSMISSION_Z', 'MW_TRANSMISSION_W1', 'MW_TRANSMISSION_W2','FLUX_IVAR_G', 'FLUX_IVAR_R', 'FLUX_IVAR_Z', 'FLUX_IVAR_W1', 'FLUX_IVAR_W2','NOBS_G', 'NOBS_R', 'NOBS_Z','PSFDEPTH_G', 'PSFDEPTH_R', 'PSFDEPTH_Z', 'GALDEPTH_G', 'GALDEPTH_R',\
       ...
       'MASKBITS','WISEMASK_W1','WISEMASK_W2', 'EBV', 'PHOTSYS','TARGETID','DESI_TARGET','BGS_TARGET','SHAPE_R', 'PHOTSYS']
...
print('')
print('old dirin', dirin)
print('old dirout', dirout)
...
# HACK: TO POINT AT REGULAR FILES
# PERHAPS THIS CAUSES AN ERROR IN WHICH CODE IS CALLED?
# dirout = '/global/cfs/cdirs/desi/survey/catalogs/DA02/LSS/guadalupe/LSScats/test/'

# TEST/HACK
# dirout = '/pscratch/sd/e/edown/DA02/LSS/guadalupe/LSScats/test/'

#dirin = dirout
print('')
print('new dirin', dirin)
print('new dirout', dirout)
print('')
...
if mkfulld:
    ...
    if args.survey == 'DA02':
        ...
        #TEST: DIR
        # TODO: change ldirspec, progl, etc
        dz = '/global/cfs/cdirs/desi/survey/catalogs/DA02/LSS/guadalupe/datcomb_bright_tarspecwdup_zdone.fits'
        tlf = '/global/cfs/cdirs/desi/survey/catalogs/DA02/LSS/guadalupe/Alltiles_bright_tilelocs.dat.fits'
    ...
    # I think this is the file that is the input
    print('dz', dz)
    print('')
    ...
    print('We are good here.')
    
if args.add_veto == 'y':
    print('Entered add_veto')
...
if args.join_etar == 'y':
    print('Entered join_etar')

    fin = dirout+type+notqso+'_full_noveto.dat.fits'
    common.join_etar(fin,type)

if args.fillran == 'y':
    print('Entered fillran')
...
if mkclusran and mkclusdat:
    print('Entered mkclusran and mkclusdat')
...
if args.add_weight_zfail == 'y':
    print('Entered add_weight_zfail')
...
if args.add_ke == 'y':
    ...
    for reg in regl:
        ...
        if args.survey != 'SV3':
            photsys = reg[1]
            print('photsys test:', photsys)

            photmask = (dat['PHOTSYS'] == photsys)
            dat = dat[photmask]
       
            print('PHOTSYS:', photsys)
            print('PHOTMASK APPLIED:', len(dat))
        else:
            # assuming all of SV3 in South / DECALS.
            #photsys='S'
        ...
        def _wrapper(N):
            ...
            data = common.add_ke(data,zcol=zcol, photsys=photsys)
...
#         tsnrcut = 1000
    ...
    # /global/cscratch1/sd/ldrm11/DA02/LSS/guadalupe/LSScats/test/
    #print(dirin)
    
    # HACK/ TODO: fix this properly
    dirin = '/global/cfs/cdirs/desi/survey/catalogs/DA02/LSS/guadalupe/LSScats/test/'
    #type2 = 'smtest'
    
    # /global/cscratch1/sd/ldrm11/DA02/LSS/guadalupe/LSScats/test/BGS_BRIGHT_
    print(dirin+type+notqso+'_', dirout+tracer_clus+'_')
